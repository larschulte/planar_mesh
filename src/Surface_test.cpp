...
int main()
{
    ...
    std::weak_ptr<Vertex> vertex1 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(0, 1, 0));
    std::weak_ptr<Vertex> vertex2 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(1, 0, 0));
    std::weak_ptr<Vertex> vertex3 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(1, 1, 0.1));
    std::weak_ptr<Vertex> vertex4 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(2, 1, 0.1));
    std::weak_ptr<Vertex> vertex5 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(1, 2, 0.1));
    std::weak_ptr<Vertex> vertex6 = storage->add_vertex(Eigen::Vector3d(0, 0, -1), Eigen::Vector3d(2, 2, 0.1));
    ...
    surface.lock()->connect(vertex3);
    std::cout << "after vertex 3, normal = [" << surface.lock()->get_normal().transpose() << "]" << std::endl;
    surface.lock()->connect(vertex4);
    std::cout << "after vertex 4, normal = [" << surface.lock()->get_normal().transpose() << "]" << std::endl;
    surface.lock()->connect(vertex5);
    std::cout << "after vertex 5, normal = [" << surface.lock()->get_normal().transpose() << "]" << std::endl;
    surface.lock()->connect(vertex6);
    std::cout << "after vertex 6, normal = [" << surface.lock()->get_normal().transpose() << "]" << std::endl;
    
    double distance = surface.lock()->compute_point_to_surface_distance_with_improved_covariance(Eigen::Vector3d(0, 0, -10), Eigen::Vector3d(0, 0, 0));
    std::cout << "distance = " << distance << std::endl;
