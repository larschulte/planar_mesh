...
{
public:
    void add_vertices(const std::unordered_set<std::shared_ptr<Vertex>, MeshObjectHash>& vertices);
    void add_edges(const std::unordered_set<std::shared_ptr<Edge>, MeshObjectHash>& edges);
