...
public:
    ...
    bool add_point_by_intersection_search(const std::shared_ptr<GenericPoint>& generic_point, std::vector<std::shared_ptr<Face>>& searched_faces, std::shared_ptr<Surface>& added_surface, std::shared_ptr<Face>& face_added_by_intersection_search);
